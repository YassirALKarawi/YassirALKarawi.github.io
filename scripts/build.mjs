...
const publicationKeywords = {
  ...
  "cybersecurity-observer-power-distribution": ["False Data Injection Attacks", "Smart Power Distribution", "Observer-Based Control", "Cybersecurity", "Resilient Control", "Cyber-Physical Systems", "State Estimation", "Power Distribution Networks"],
  "fir-filter-transient-compensation": ["FIR Digital Filters", "Transient Compensation", "Impulse Response Stability", "Digital Filter Design", "Signal Processing", "Transient Effects", "Finite Impulse Response", "Filter Stability"],
  "off-grid-oran-ris-edge-energy": ["Off-Grid Open RAN", "Reconfigurable Intelligent Surfaces", "Edge Computing", "Energy Efficiency", "Open RAN", "Renewable Energy", "Resource Optimisation", "6G Networks"],
  "quantum-load-balancing-open-ran-energy": ["Quantum-Based Load Balancing", "Open RAN", "Energy Efficiency", "Radio Access Networks", "Resource Allocation", "Network Optimisation", "Power Consumption", "6G Networks"],
  "power-consumption-next-generation-open-ran": ["Open RAN Power Consumption", "Energy Efficiency", "Next-Generation Networks", "Open Radio Access Network", "Network Energy Modelling", "Green Communications", "6G Networks", "Power Evaluation"],
  "cloud-data-center-placement-virtualized": ["Cloud Data Center Placement", "Virtualised Environments", "Cloud Computing", "Data Centre Optimisation", "Resource Allocation", "Network Optimisation", "Virtualisation", "Cloud Infrastructure"],
  "qos-quantum-entanglement-mobile-networks": ["Quantum Entanglement", "Quality of Service", "Mobile Networks", "Quantum Communications", "Entanglement Distribution", "Network Performance", "Quantum Networking", "Wireless Networks"],
  "trade-offs-5g-networks-beyond": ["5G Networks", "Beyond 5G", "Network Trade-Offs", "Quality of Service", "Energy Efficiency", "Spectral Efficiency", "Wireless Networks", "6G Evolution"],
  ...
  "atpc-haps-terrestrial-5-7ghz": ["Automatic Transmit Power Control", "ATPC", "High-Altitude Platform Systems", "HAPS", "Terrestrial Systems", "5.7 GHz Band", "Spectrum Sharing", "Interference Mitigation"]
};
...
function publicationCard(pub, compact = false) {
  return `<article class="publication-card${compact ? " compact" : ""}" data-publication data-year="${pub.year}" data-type="${escapeHtml(pub.type)}" data-theme="${escapeHtml(pub.themes.join(" "))}" data-search="${escapeHtml(`${pub.title} ${pub.authors.join(" ")} ${pub.venue} ${pub.themes.join(" ")} ${pub.keywords.join(" ")} ${pub.doi || ""}`.toLowerCase())}">
...
function publicationPage(pub) {
  ...
  const citationMeta = [
    ...
    `<meta name="citation_keywords" content="${escapeHtml(pub.keywords.join("; "))}">`,
    ...
    ...pub.keywords.map(keyword => `<meta name="DC.subject" content="${escapeHtml(keyword)}">`),
...
const discoveryStyles = `.data-links{display:flex;flex-wrap:wrap;gap:8px;justify-content:flex-end}.data-links a{display:inline-flex;align-items:center;border:1px solid rgba(255,255,255,.24);padding:7px 10px;font-size:.72rem;font-weight:800}.record-id a+a{margin-top:8px}.record-keywords{margin-top:42px;padding-top:30px;border-top:1px solid var(--line)}.record-keywords h2{font-size:1.45rem}.record-keywords .tags{max-width:780px}.record-keywords .tags span{background:var(--white)}@media(max-width:760px){.data-links{grid-column:1/-1;justify-content:flex-start}}`;
